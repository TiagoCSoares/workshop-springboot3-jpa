package com.tiagocsoares.course.config;

import com.tiagocsoares.course.entities.*;
import com.tiagocsoares.course.repositories.*;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        // This method will be executed when the application is started
